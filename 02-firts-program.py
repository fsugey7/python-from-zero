...
# 3- Otra operación que hace la mayoria de los programas es la EJECUCIÓN CONDICIONAL, que dependiendo de los valores ingresados, ejecuta el programa de cierta forma.
# Python trae para esto las ESTRUCTURAS DE CONTROL, que también conoceremos más adelante.

# 4- También los programas realizan operaciones con los valores, ya sean combinados, sumando, acumulando, calculando. etc.
