# Podemos pensar que en Python todo es un valor que hemos visto son:
# "Hola Mundo", 2, 4, "Harvys". Todos los valores tienen un TIPO. Y depende del tipo los operaciones que podemos realizar con ellos

# Para ver el tipo de un valor tenemos la función Type()

print(type("Hola Mundo")) # Los textos son de tipo string o str
print(type(2)) # Los númeos enteros son de tipo int
